...
//#[test]
fn test2() {
    assert_eq!(execute(vec!(0, 3, 6), 30000000), 175594);
    assert_eq!(execute(vec!(1, 3, 2), 30000000), 2578);
    assert_eq!(execute(vec!(2, 1, 3), 30000000), 3544142);
    assert_eq!(execute(vec!(1, 1, 3), 30000000), 261214);
    assert_eq!(execute(vec!(2, 3, 1), 30000000), 6895259);
    assert_eq!(execute(vec!(3, 2, 1), 30000000), 18);
    assert_eq!(execute(vec!(3, 2, 1), 30000000), 362);
}
...
fn main() {
    println!(
        "Loop exited. Acc {}",
        execute(vec!(12, 1, 16, 3, 11, 0), 30000000)
    );
}
